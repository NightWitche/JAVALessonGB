    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            try (FileWriter wr = new FileWriter("peopleDB.sql")) {
                wr.append("Селеверстов Андрей Константинович 48 М\n");
                wr.append("Савин Павел Дмитриевич 29 М\n");
                wr.append("Петросян Эльвира Вахаровна 18 Ж\n");
                wr.append("Холодец Алена Степановна 43 Ж\n");
                wr.append("Красносельцев Алексей Романович 22 М\n");
                wr.append("Дан Елена Павловна 67 Ж\n");
                wr.append("Путилов Яков Сергеевич 19 М\n");
                wr.append("Яблонев Нестор Петрович 39 М\n");
                wr.append("Малежко Александра Степановна 30 Ж\n");
                wr.flush();
            }
        } catch (IOException e) {
