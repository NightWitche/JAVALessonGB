...
public class HW5 {
    ...
    public static void main(String[] args) {
        ...
        hashMap.put(1, "Трубилов Юрий Борисович 40 м");
        hashMap.put(3, "Костоправова Елена Денисовна 20 ж");
        hashMap.put(6, "Серебряков Александр Анатольевич 80 м");
        hashMap.put(8, "Адарова Гульнар Харибовна 35 ж");
        hashMap.put(9, "Стройный Герман Андреевич 50 ж");
